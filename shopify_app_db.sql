...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 16, 2024 at 10:33 PM
...
(1, 'John Doe', 'john.doe@example.com', 'hashed_password_example', 'customer', '2024-10-09 19:28:20', '2024-10-09 19:28:20');
...
--
ALTER TABLE `admin_actions`
  ADD CONSTRAINT `admin_actions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);
